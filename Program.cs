...
namespace DIO.Animes
{
    class Program
    {
		...
		{
			Console.Write("Digite o id ddo Anime: ");
        ...
        private static void ExcluirAnime()
		{
            ...
            int indiceAnime = int.Parse(Console.ReadLine());
            Console.Write("Deseja mesmo excluir este Anime? Digite 'Sim' para confirmar:  ");
            ...
            {
                Console.Write("Digite o id do Anime que deseja excluir: ");
                indiceAnime = int.Parse(Console.ReadLine());
                repositorio.Exclui(indiceAnime);
            }
